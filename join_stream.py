...
orders_stream = spark.readStream \
    ...
    .option("kafka.sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required username='ZGKLHNNFF4MLTJIE' password='WU8TnzgSqvvebeV0sJUvGxgauQXAe3A3yGcXMm2psGcDF6HgGiOr3JfhD36bBeIJ';") \
    .load() \
...
checkpoint_dir = "gs://streaming_checkpointing_new/kafka_stream_checkpoint"
